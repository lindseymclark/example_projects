    ...
    def transform_train_data_headers(data: pd.DataFrame) -> pd.DataFrame:
        ...
        data = data.rename(
            columns={
                0: "UnitNumber",
                1: "Cycle",
                2: "OperationalSetting1",
                3: "OperationalSetting2",
                4: "OperationalSetting3",
                5: "SensorMeasurement1",
                6: "SensorMeasurement2",
                7: "SensorMeasurement3",
                8: "SensorMeasurement4",
                9: "SensorMeasurement5",
                10: "SensorMeasurement6",
                11: "SensorMeasurement7",
                12: "SensorMeasurement8",
                13: "SensorMeasurement9",
                14: "SensorMeasurement10",
                15: "SensorMeasurement11",
                16: "SensorMeasurement12",
                17: "SensorMeasurement13",
                18: "SensorMeasurement14",
                19: "SensorMeasurement15",
                20: "SensorMeasurement15",
                21: "SensorMeasurement16",
                22: "SensorMeasurement17",
                23: "SensorMeasurement18",
                24: "SensorMeasurement19",
                25: "SensorMeasurement20",
            }
        )
        data = data.drop([26, 27], axis=1)
        return data

    def combine_engine_failure_data(
        data: pd.DataFrame, failure_data: str
    ) -> pd.DataFrame:
        ...
        final_dataset = data.merge(
            failure_cycle_data, left_on="UnitNumber", right_on="Unit"
        )
